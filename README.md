...
**Главное окно:**
- Поле ввода даты (формат: ДД.ММ.ГГГГ) с автоматической валидацией и форматированием
- Визуальный календарь (всегда видимый) с выделением выходных (Сб, Вс) красным цветом
- Live preview курса валюты рядом с полем даты
- Радиокнопки выбора валюты: USD / EUR
- Поле ввода суммы с поддержкой европейского и американского форматов
- Кнопка "Конвертировать"
- Поле результата: `"80 722,00 руб. ($1 000,00 по курсу 80,7220)"`
- Кнопка "Копировать в буфер" (использует navigator.clipboard API)
- Строка состояния с информацией о последней операции
...
|-------|---------------|-----------|
| HTML парсинг (legacy) | ~50-100 мс | baseline |
...
### Утилиты
- **navigator.clipboard** - Работа с буфером обмена (Web API в frontend)
...
Мы рады вашему вкладу в проект! Пожалуйста, ознакомьтесь с нашим **[Руководством для контрибьюторов](CONTRIBUTING.md)** для получения подробной информации о:
...
- ✅ Актуализирована документация (Wails v2, XML API)
