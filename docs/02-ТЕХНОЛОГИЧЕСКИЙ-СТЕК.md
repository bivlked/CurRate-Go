...
**Обновлено:** 22 декабря 2025 - актуализация зависимостей (удален goquery, добавлен golang.org/x/text)
...
**Обновлено:** 22.12.2025 (v2.2 - актуализация зависимостей, удален goquery)
